...
### research/attribution/ — **Block 6 Attribution v1 BUILT (2026-08-05, 4 tests)**
...
- `research/attribution/__init__.py` — exports `AttributionResult`, `decompose_backtest`

### tests/ — **113 passing, 1 skipped (Python)** + **66 passing (C++, `ctest --test-dir engine/build`)**
| file | covers |
|---|---|
