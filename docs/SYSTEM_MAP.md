...
### research/attribution/ — **Block 6 Attribution + book scorecard v1 BUILT (2026-08-05, 12 tests)**
...
- `research/attribution/__init__.py` — exports `AttributionResult`, `BookScorecard`, `decompose_backtest`, `score_backtest`

### tests/ — **121 passing, 1 skipped (Python)** + **66 passing (C++, `ctest --test-dir engine/build`)**
| file | covers |
|---|---|
