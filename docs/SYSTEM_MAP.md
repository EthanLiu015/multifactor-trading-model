...
### engine/ — **built (broker simulator + order gateway + position keeper + risk checker + market data handler + live AlpacaGateway + execution scheduler + kill switch + compliance checker, 76 Catch2 tests, live end-to-end verified)**
...
### tests/ — **123 passing, 1 skipped (Python)** + **76 passing (C++, `ctest --test-dir engine/build`)**
| file | covers |
|---|---|
