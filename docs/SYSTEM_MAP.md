...
### engine/ — **built (broker simulator + order gateway + position keeper + risk checker + market data handler + live AlpacaGateway, 47 Catch2 tests, live end-to-end verified)**
...
### tests/ — **106 passing, 1 skipped (Python)** + **47 passing (C++, `ctest --test-dir engine/build`)**
| file | covers |
|---|---|
